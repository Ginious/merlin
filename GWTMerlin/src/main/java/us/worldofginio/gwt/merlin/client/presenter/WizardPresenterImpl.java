...
public class WizardPresenterImpl implements WizardPresenter, ClickHandler {
	 ...
	 */
	private Map<WizardStepViewIdentifier, WizardStepPresenter> presenters = new HashMap<WizardStepViewIdentifier, WizardStepPresenter>();

	/**
	 * Actions that will be available.
	 */
	private List<WizardActionIdentifier> actions = new ArrayList<WizardActionIdentifier>();
