...
public class WizardStepPresenter4ChildName extends AbstractWizardStepPresenter implements WizardStepView4CertificateName.Presenter {

	public WizardStepPresenter4ChildName() {
		super(new WizardStepView4CertificateName());
	}
